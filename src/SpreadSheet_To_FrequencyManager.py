...
for i, active_sheet in enumerate(workbook.sheetnames):
    ...
    if 'WATERFALL' in first_row_value:
        ...
        show_on_waterfall = bool(first_row_value_split[1])
    else:
        show_on_waterfall = False
    ...
    # Read in each Worksheet line and put in results in a list
    ...
    # Can not have duplicate names in the 'name' column (SDR++ design requirement)
