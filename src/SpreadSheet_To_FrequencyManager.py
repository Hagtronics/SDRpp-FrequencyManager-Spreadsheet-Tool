...
for i, active_sheet in enumerate(workbook.sheetnames):
    ...
    try:
        ...
        msg = f'''\n\n\nError!\n'''\
              f'''The 'Show On Waterfall' parameter on sheet: {active_sheet}.\n'''\
              f'''Was not in the correct form. The correct form is: 'Show On Waterfall=True' or 'Show On Waterfall=False'.\n'''\
              f'''Fix the error and re-run this program.\n'''
        print(msg)
        sys.exit(-4)
